...
const { 
  wmaOver, stochasticCrossedOver, stochasticCrossedUnder, rateAboveWma 
...
const PATH  = `../../cache/stats/wmaStoch/long/${interval}/${abbrev}`;
...
const stopLosses = [null, 50];
// const stopGains = [null];

const wmas = [15, 30, 50, 100, 200];
...
const algorithms = [
  ...
  // },
  {
    open: (shortWma, longWma) => trigger => (p, c) => wmaOver(c, shortWma, longWma) && rateAboveWma(c, shortWma)
      && stochasticCrossedOver(p, c, trigger),
